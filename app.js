      ...
      get: {
        ...
        quick: {
          ...
          progress: {
            ...
            completionHint:
              "Quick start completed. Open current status to continue.",
            labels: {
              step1: "1/3",
              step2: "2/3",
              step3: "3/3",
      ...
      get: {
        ...
        quick: {
          ...
          progress: {
            ...
            completionHint: "快速开始已完成，立即查看项目状态继续。",
            labels: {
              step1: "1/3",
              step2: "2/3",
              step3: "3/3",
...
function setQuickStartProgressState() {
  ...
  if (isCompleted) {
    ...
    const completionHintMessage =
      quickStartProgressLabel.dataset.completionHint ||
